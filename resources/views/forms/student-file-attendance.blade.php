...
@if ( $segment == 'edit' )
    {{ Form::open(array('url' => 'academics/attendance-sheets/student-attendance/file-attendance/update/'.$attendancesheets->id, 'name' => 'attendancesheets_form', 'method' => 'PUT')) }}
@else
    {{ Form::open(array('url' => 'academics/attendance-sheets/student-attendance/file-attendance/store', 'name' => 'attendancesheets_form', 'method' => 'POST')) }}
@endif
    <div class="row">
