@if ( $segment == 'edit' )
    {{ Form::open(array('url' => 'components/schools/schoolyears/update/'.$batch->id, 'name' => 'batch_form', 'method' => 'PUT')) }}
@else
    {{ Form::open(array('url' => 'components/schools/schoolyears/store', 'name' => 'batch_form', 'method' => 'POST')) }}
@endif
    <div class="row">
