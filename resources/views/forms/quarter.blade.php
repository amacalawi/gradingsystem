@if ( $segment == 'edit' )
    {{ Form::open(array('url' => 'schools/quarters/update/'.$quarter->id, 'name' => 'quarter_form', 'method' => 'PUT')) }}
@else
    {{ Form::open(array('url' => 'schools/quarters/store', 'name' => 'quarter_form', 'method' => 'POST')) }}
@endif
    <div class="row">
