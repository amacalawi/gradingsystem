                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <div class="flex align-items-center">
                                ...
                                <div>
                                    <a title="move to inactive {{ strtolower(Request::segment(4)) }}" href="{{ url('/'.Request::segment(1).'/'.Request::segment(2).'/'.Request::segment(3).'/inactive-outbox') }}" class="pull-right moves m--font-danger">
