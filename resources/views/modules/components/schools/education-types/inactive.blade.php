                        ...
                        <div class="flex align-items-center">
                            <div class="mr-auto">
                                <h3 class="m-portlet__head-text">
                                    All Inactive {{ ucwords(str_replace('-',' ',Request::segment(3))) }} 
                                </h3> 
                            </div>
                            <div>
                                <a title="move to active {{ strtolower(Request::segment(3)) }}" href="{{ url('/'.Request::segment(1).'/'.Request::segment(2).'/'.Request::segment(3)) }}" class="pull-right moves moves-back m--font-info">
                                    <i class="la la-angle-double-left"></i> ACTIVE {{ strtoupper(str_replace('-',' ',Request::segment(3))) }} 
                                </a>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    <script src="{{ asset('js/datatables/inactive-education-type.js') }}" type="text/javascript"></script>
@endpush
