!function($) {
    ...
    admission.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    admission.prototype.required_fields = function() {
    ...
    admission.prototype.price_separator = function (input) {
        var output = input
        if (parseFloat(input)) {
    ...
    admission.prototype.do_uploads = function($id) {
    ...
    admission.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            e.preventDefault();
            var $self = $(this);
            var $form = $('form[name="admission_form"]');
            var $error = $.admission.validate($form, 0);
                                ...
                                swal({
                                    ...
                                    onClose: () => {
                                        if ($form.find("input[name='method']").val() == 'add') {
                                            window.location.replace(base_url + 'academics/admissions/sectionsstudents');
                                        }
                                    }
                                });
    ...
    //init admission
    $.admission = new admission, $.admission.Constructor = admission

}(window.jQuery),

//initializing admission
function($) {
    "use strict";
    $.admission.required_fields();
    $.admission.init();
