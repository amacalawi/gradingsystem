!function($) {
    ...
    var presetmsg = function() {
        this.$body = $("body");
    };

    var $required = 0; var files = []; var filesName = [];

    presetmsg.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    presetmsg.prototype.required_fields = function() {
    ...
    presetmsg.prototype.price_separator = function (input) {
        var output = input
        if (parseFloat(input)) {
    ...
    presetmsg.prototype.do_uploads = function($id) {
    ...
    presetmsg.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            e.preventDefault();
            var $self = $(this);
            var $form = $('form[name="presetmsg_form"]');
            var $error = $.presetmsg.validate($form, 0);
                                ...
                                swal({
                                    ...
                                    onClose: () => {
                                        if ($form.find("input[name='method']").val() == 'add') {
                                            window.location.replace(base_url + 'components/schedules/preset-message');
                                        }
                                    }
                                });
    ...
    //init presetmsg
    $.presetmsg = new presetmsg, $.presetmsg.Constructor = presetmsg

}(window.jQuery),

//initializing presetmsg
function($) {
    "use strict";
    $.presetmsg.required_fields();
    $.presetmsg.init();
