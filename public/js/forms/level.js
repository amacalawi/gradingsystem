!function($) {
    ...
    level.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    level.prototype.required_fields = function() {
    ...
    level.prototype.price_separator = function (input) {
        var output = input
        if (parseFloat(input)) {
    ...
    level.prototype.do_uploads = function($id) {
    ...
    {   
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            e.preventDefault();
            var $self = $(this);
            var $form = $('form[name="level_form"]');
            var $error = $.level.validate($form, 0);
                                ...
                                swal({
                                    ...
                                    onClose: () => {
                                        if ($form.find("input[name='method']").val() == 'add') {
                                            window.location.replace(base_url + 'academics/academics/levels');
                                        }
                                    }
                                });
    ...
    //init level
    $.level = new level, $.level.Constructor = level
