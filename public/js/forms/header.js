!function($) {
    ...
    header.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    header.prototype.required_fields = function() {
    ...
    header.prototype.price_separator = function (input) {
        var output = input
        if (parseFloat(input)) {
    ...
    header.prototype.do_uploads = function($id) {
    ...
    {   
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var $error = $.header.validate($form, 0);
                                ...
                                swal({
                                    ...
                                    onClose: () => {
                                        if ($form.find("input[name='method']").val() == 'add') {
                                            window.location.replace(base_url + 'components/menus/headers');
                                        }
                                    }
                                });
    ...
    //init header
    $.header = new header, $.header.Constructor = header
