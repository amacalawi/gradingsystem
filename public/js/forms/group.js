!function($) {
    ...
    group.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    group.prototype.required_fields = function() {
    ...
    group.prototype.price_separator = function (input) {
        var output = input
        if (parseFloat(input)) {
    ...
    group.prototype.do_uploads = function($id) {
    ...
    {   
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            e.preventDefault();
            var $self = $(this);
            var $form = $('form[name="group_form"]');
            var $error = $.group.validate($form, 0);
                                ...
                                swal({
                                    ...
                                    onClose: () => {
                                        if ($form.find("input[name='method']").val() == 'add') {
                                            window.location.replace(base_url + 'components/groups');
                                        }
                                    }
                                });
    ...
    //init group
    $.group = new group, $.group.Constructor = group
