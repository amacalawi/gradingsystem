!function($) {
    ...
    var soa_template = function() {
        this.$body = $("body");
    };

    var $required = 0; var files = []; var filesName = [];

    soa_template.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    soa_template.prototype.required_fields = function() {
    ...
    soa_template.prototype.price_separator = function (input) {
        var output = input
        if (parseFloat(input)) {
    ...
    soa_template.prototype.do_uploads = function($id) {
    ...
    soa_template.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            e.preventDefault();
            var $self = $(this);
            var $form = $('form[name="soa_template_form"]');
            var $error = $.soa_template.validate($form, 0);
                                ...
                                swal({
                                    ...
                                    onClose: () => {
                                        if ($form.find("input[name='method']").val() == 'add') {
                                            window.location.replace(base_url + 'components/csv-management/soa-template-01');
                                        }
                                    }
                                });
    ...
    //init soa_template
    $.soa_template = new soa_template, $.soa_template.Constructor = soa_template

}(window.jQuery),

//initializing soa_template
function($) {
    "use strict";
    $.soa_template.required_fields();
    $.soa_template.init();
