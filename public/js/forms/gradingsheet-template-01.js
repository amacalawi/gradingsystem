!function($) {
    ...
    var gradingsheet_template = function() {
        this.$body = $("body");
    };

    var $required = 0; var files = []; var filesName = [];

    gradingsheet_template.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    gradingsheet_template.prototype.required_fields = function() {
    ...
    gradingsheet_template.prototype.price_separator = function (input) {
        var output = input
        if (parseFloat(input)) {
    ...
    gradingsheet_template.prototype.do_uploads = function($id) {
    ...
    gradingsheet_template.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            e.preventDefault();
            var $self = $(this);
            var $form = $('form[name="gradingsheet_template_form"]');
            var $error = $.gradingsheet_template.validate($form, 0);
            ...
            if ($error != 0) {
                ...
                window.onfocus = null;   
                $.gradingsheet_template.required_fields();
            } else {
                                ...
                                swal({
                                    ...
                                    onClose: () => {
                                        if ($form.find("input[name='method']").val() == 'add') {
                                            window.location.replace(base_url + 'components/csv-management/gradingsheet-template-01');
                                        }
                                    }
                                });
    ...
    //init gradingsheet_template
    $.gradingsheet_template = new gradingsheet_template, $.gradingsheet_template.Constructor = gradingsheet_template

}(window.jQuery),

//initializing gradingsheet_template
function($) {
    "use strict";
    $.gradingsheet_template.required_fields();
    $.gradingsheet_template.init();
}(window.jQuery);
