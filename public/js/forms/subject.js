!function($) {
    ...
    subject.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    subject.prototype.required_fields = function() {
    ...
    subject.prototype.price_separator = function (input) {
        var output = input
        if (parseFloat(input)) {
    ...
    subject.prototype.do_uploads = function($id) {
    ...
    {   
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var $error = $.subject.validate($form, 0);
                                ...
                                swal({
                                    ...
                                    onClose: () => {
                                        if ($form.find("input[name='method']").val() == 'add') {
                                            window.location.replace(base_url + 'academics/academics/subjects');
                                        }
                                    }
                                });
        ...
        this.$body.on('change', 'input[name=material]', function (e){
            ...
            if ( $('input[name=material]:checked').val() == 1 ){
                $('input[name=is_mapeh]').prop('checked', false).removeAttr("disabled");
                $('input[name=is_tle]').prop('checked', false).removeAttr("disabled");
            } else {
    ...
    //init subject
    $.subject = new subject, $.subject.Constructor = subject
