!function($) {
    ...
    var sub_module = function() {
        this.$body = $("body");
    };

    var $required = 0; var files = []; var filesName = [];

    sub_module.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    sub_module.prototype.required_fields = function() {
    ...
    sub_module.prototype.price_separator = function (input) {
        var output = input
        if (parseFloat(input)) {
    ...
    sub_module.prototype.do_uploads = function($id) {
    ...
    sub_module.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            e.preventDefault();
            var $self = $(this);
            var $form = $('form[name="sub_module_form"]');
            var $error = $.sub_module.validate($form, 0);
                                ...
                                swal({
                                    ...
                                    onClose: () => {
                                        if ($form.find("input[name='method']").val() == 'add') {
                                            window.location.replace(base_url + 'components/menus/sub-modules');
                                        }
                                    }
                                });
    ...
    //init sub_module
    $.sub_module = new sub_module, $.sub_module.Constructor = sub_module

}(window.jQuery),

//initializing sub_module
function($) {
    "use strict";
    $.sub_module.required_fields();
    $.sub_module.init();
