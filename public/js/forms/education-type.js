!function($) {
    ...
    var education_type = function() {
        this.$body = $("body");
    };

    var $required = 0; var files = []; var filesName = [];

    education_type.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    education_type.prototype.required_fields = function() {
    ...
    education_type.prototype.price_separator = function (input) {
        var output = input
        if (parseFloat(input)) {
    ...
    education_type.prototype.do_uploads = function($id) {
    ...
    education_type.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            e.preventDefault();
            var $self = $(this);
            var $form = $('form[name="education_type_form"]');
            var $error = $.education_type.validate($form, 0);
            ...
            if ($error != 0) {
                ...
                window.onfocus = null;   
                $.education_type.required_fields();
            } else {
                                ...
                                swal({
                                    ...
                                    onClose: () => {
                                        if ($form.find("input[name='method']").val() == 'add') {
                                            window.location.replace(base_url + 'components/schools/education-types');
                                        }
                                    }
                                });
    ...
    //init education_type
    $.education_type = new education_type, $.education_type.Constructor = education_type

}(window.jQuery),

//initializing education_type
function($) {
    "use strict";
    $.education_type.required_fields();
    $.education_type.init();
