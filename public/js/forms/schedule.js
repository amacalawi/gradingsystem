!function($) {
    ...
    schedule.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    schedule.prototype.required_fields = function() {
    ...
    schedule.prototype.price_separator = function (input) {
        var output = input
        if (parseFloat(input)) {
    ...
    schedule.prototype.do_uploads = function($id) {
    ...
    {   
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var $error = $.schedule.validate($form, 0);
                                ...
                                swal({
                                    ...
                                    onClose: () => {
                                        if ($form.find("input[name='method']").val() == 'add') {
                                            window.location.replace(base_url + 'components/schedules');
                                        }
                                    }
                                });
    ...
    //init schedule
    $.schedule = new schedule, $.schedule.Constructor = schedule
