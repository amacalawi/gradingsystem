!function($) {
    ...
    var fileattendance = function() {
        this.$body = $("body");
    };

    var $required = 0; var files = []; var filesName = [];

    fileattendance.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    fileattendance.prototype.required_fields = function() {
        ...
        | ---------------------------------
        */
    fileattendance.prototype.get_all_siblings = function() {
    ...
    fileattendance.prototype.price_separator = function (input) {
        var output = input
        if (parseFloat(input)) {
    ...
    fileattendance.prototype.do_uploads = function($id) {
    ...
    fileattendance.prototype.init = function()
    {   
        $.fileattendance.get_all_siblings();
        /*
        | ---------------------------------
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var $error = $.fileattendance.validate($form, 0);
            ...
            if ($error != 0) {
                ...
                window.onfocus = null;   
                $.fileattendance.required_fields();
            } else {
    ...
    //init fileattendance
    $.fileattendance = new fileattendance, $.fileattendance.Constructor = fileattendance
