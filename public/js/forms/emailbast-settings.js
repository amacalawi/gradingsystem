!function($) {
    ...
    var emailblastsettings = function() {
        this.$body = $("body");
    };

    var $required = 0; var files = []; var filesName = [];

    emailblastsettings.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    emailblastsettings.prototype.required_fields = function() {
    ...
    emailblastsettings.prototype.price_separator = function (input) {
        var output = input
        if (parseFloat(input)) {
    ...
    emailblastsettings.prototype.do_uploads = function($id) {
    ...
    emailblastsettings.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var $error = $.emailblastsettings.validate($form, 0);
            ...
            if ($error != 0) {
                ...
                window.onfocus = null;   
                $.emailblastsettings.required_fields();
            } else {
                                ...
                                swal({
                                    ...
                                    onClose: () => {
                                        if ($form.find("input[name='method']").val() == 'add') {
                                            window.location.replace(base_url + 'notifications/messaging/emailblast/settings');
                                        }
                                    }
                                });
    ...
    //init emailblastsettings
    $.emailblastsettings = new emailblastsettings, $.emailblastsettings.Constructor = emailblastsettings

}(window.jQuery),

//initializing emailblastsettings
function($) {
    "use strict";
    $.emailblastsettings.required_fields();
    $.emailblastsettings.init();
}(window.jQuery);
