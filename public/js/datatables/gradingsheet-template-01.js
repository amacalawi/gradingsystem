...
var DatatableDataLocalDemo = function () {
	//== Private functions
 	console.log(base_url + 'components/csv-management/gradingsheet-template-01/all-active');
		...
		data: {
			...
			source: {
			  read: {
				// sample GET method
				method: 'GET',
				url: base_url + 'components/csv-management/gradingsheet-template-01/all-active',
				map: function(raw) {
				  // sample data mapping
				  var dataSet = raw;
	...
	var demo = function () {
		...
		$('#m_form_type').on('change', function () {
			datatable.search($(this).val(), 'gradingsheet_templateType');
		}).val(typeof query.gradingsheet_templateType !== 'undefined' ? query.gradingsheet_templateType : '');
...
jQuery(document).ready(function () {
	...
	$('#import-gradingsheet-template-01-dropzone').dropzone({
		acceptedFiles: accept,
		init: function () {
		this.on("processing", function(file) {
			this.options.url = base_url + '/components/csv-management/gradingsheet-template-01/import';
