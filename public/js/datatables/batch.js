...
var DatatableDataLocalDemo = function () {
	//== Private functions
 	console.log(base_url + 'schools/batches/all-active');
		...
		data: {
			...
			source: {
			  read: {
				// sample GET method
				method: 'GET',
				url: base_url + 'schools/batches/all-active',
				map: function(raw) {
				  // sample data mapping
				  var dataSet = raw;
					...
					<div class="dropdown ' + dropup + '">\
						<a href="#" class="btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" data-toggle="dropdown">\
						  ...
						  <div class="dropdown-menu dropdown-menu-right">\
							<a title="edit this" class="dropdown-item" href="' + base_url + 'schools/batches/edit/' + row.batchID + '"><i class="la la-edit"></i> Edit Details</a>\
