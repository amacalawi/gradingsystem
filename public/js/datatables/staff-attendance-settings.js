...
var DatatableDataLocalDemo = function () {
	//== Private functions
 	console.log(base_url + 'academics/attendance-sheets/staff-attendance/settings/all-active');
	...
	var datatable = $('.m_datatable').mDatatable({
		...
		data: {
			...
			source: {
			  read: {
				// sample GET method
				method: 'GET',
				url: base_url + 'academics/attendance-sheets/staff-attendance/settings/all-active',
				map: function(raw) {
				  // sample data mapping
				  var dataSet = raw;
		...
		columns: [{
			...
			field: "staffsettingsStaffNo",
            title: "Staff No.",
            width: 100,
		}, {
			field: "staffsettingsSchedule",
            title: "Schedule",
            width: 100,
		}, {
			field: "staffsettingsModified",
			title: "Last Modified",
		}, {
			field: "Actions",
			width: 50,
