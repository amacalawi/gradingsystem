...
var DatatableDataLocalDemo = function () {
	//== Private functions
 	console.log(base_url + 'schools/designations/all-active');
	...
	var datatable = $('.m_datatable').mDatatable({
		...
		data: {
			...
			source: {
			  read: {
				// sample GET method
				method: 'GET',
				url: base_url + 'schools/designations/all-active',
				map: function(raw) {
				  // sample data mapping
				  var dataSet = raw;
		...
		columns: [{
			...
			template: function (row, index, datatable) {
                ...
                return '\
                    <a title="edit this" class=" m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" href="' + base_url + 'schools/designations/edit/' + row.designationID + '"><i class="la la-edit"></i></a>\
