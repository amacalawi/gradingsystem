...
class StaffFileAttendanceController extends Controller
{
    ...
    {   
        ...
        return view('modules/attendancesheets/staffs/edit')->with(compact('menus', 'attendancesheets', 'student', 'types', 'segment', 'flashMessage'));
    }
    ...
    {   
        ...
        $staff_arr = explode(' - ', $request->staff);
        $staff_id = Student::where('identification_no', $staff_arr[0] )->first()->id;
    ...
    {   
        ...
        $attendancesheets->user_id = $staff_id;
