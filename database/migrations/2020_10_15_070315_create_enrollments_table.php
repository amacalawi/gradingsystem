...
class CreateEnrollmentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('enrollments', function (Blueprint $table) {
            ...
            $table->string('student_payment_terms', 100)->nullable();
            $table->string('student_sibling_discount', 100)->nullable();
            $table->string('student_subsidy_grantee', 100)->nullable();
            $table->string('student_payment_option', 100)->nullable();
            $table->string('student_acknowledge_1', 10)->nullable();
            $table->string('student_acknowledge_2', 10)->nullable();
            $table->string('student_acknowledge_3', 10)->nullable();
            $table->string('student_acknowledge_4', 10)->nullable();
